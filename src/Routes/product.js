...
const { createProduct, getProduct, getProductById, getSigleProduct, searchProduct, createRating } = require("../controllers/product");
...
router.post('/product/productrating',createRating)
